...
function renderizarDadosUsuario(dados) {
  ...
  imagem.setAttribute('src',`${dados.resultado[0].imagem.grande}`)
  console.log(imagem)


  nome.innerHTML =  dados.resultado[0].nome.primeiro + ' ' + dados.resultado[0].nome.utlimo + ', ' + dados.resultado[0].dob.idade;
  genero.innerHTML = `Gênero: ${dados.resultado[0].genero}`
  localizacao.innerHTML = `
  Rua: ${dados.resultado[0].localizacao.rua},</br> Cidade: ${dados.resultado[0].localizacao.cidade} </br>
  Email: ${dados.resultado[0].email}`
  console.log(dados);
...
// Membros do grupo
// Gabriel Rizzo, Marcel Gava, Geyson Kaio, Thaisa Sicco e Bruno Neves
